...
<section id="main-content-section">
    <div class="main-content">
        <section id="product_edit">
            <form action="${pageContext.request.contextPath}/admin/order/new" method="post" id="order-form">
                <div class="container">
                    <div class="row">
                                ...
                                <div class="left-container">
                                    <section id="order-info">
                                        ...
                                        <select name="status" class="select" id="select_order_date">
                                            <c:forEach var="i" begin="0" end="3">
                                                <option value="${i}">${requestScope.status[i]}</option>
                                            </c:forEach>
                                        </select>
                                    </section>
                                    <section id="customer-info">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <button type="button" id="btn-load-data" class="btn btn-primary d-flex align-items-center gap-2 px-2 text-wheat-color fw-semibold">
                                        ...
                                        <div class="customer-contact">
                                            <ul>
                                                <li>
                                                    ...
                                                    <span id="user-email">email người dùng</span>
                                                </li>
                                                <li>
                                                    <i class="fa-solid fa-phone-volume"></i>
                                                    <span id="user-phone">xxx-xxx-xxx</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </section>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="input-field">
                                                    ...
                                                    <input type="text" name="receiverName" placeholder="Họ và tên" id="receiverName">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="input-field">
                                                    <label for="receiverEmail">Email *</label>
                                                    <input type="text" name="receiverEmail" placeholder="Email" id="receiverEmail">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                            <div class="col-md-6">
                                                <div class="input-field">
                                                    ...
                                                    <input type="text" name="receiverPhone" placeholder="Số điện thoại" id="receiverPhone">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="input-field">
                                                    <label for="receiverAddress">Địa chỉ nhận hàng *</label>
                                                    <input type="text" name="receiverAddress" placeholder="Địa chỉ" id="receiverAddress">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mt-3">
...
<script src="${pageContext.request.contextPath}/libs/DataTables/datatables.min.js"></script>
<script src="${pageContext.request.contextPath}/js/admin/order-new.js?v=5"></script>
</body>
</html>
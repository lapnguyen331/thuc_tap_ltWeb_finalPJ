...
<%@include file="/WEB-INF/view/shared/header.jsp" %>
                ...
                <span class="icon" id="toggle-login-password">
                  ...
                  <i class="fa-solid fa-lock fa-sm"></i>
                    ...
                    <div class="icons">
                        ...
                        <a href="#" class="icons-btn facebook">
    ...
    &client_id=1037251831730-fnl81cdfmlvkrj09qkpt2ad6inqeosnh.apps.googleusercontent.com&approval_prompt=force" class="icons-btn google">
